...
export default function ProjectTable({
      ...
      setProjectList((prev) =>
        prev.map((project) =>
          project.id === selectedProject.id
            ? { ...project, title: editData.title, description: editData.description }
            : project
        )
      );
  ...
  const handleDeleteProject = async () => {
    ...
    setIsLoading(true);
    try {
      const deletingProjectId = selectedProject.id;
      await onDeleteProject(deletingProjectId);
      setProjectList((prev) => prev.filter((project) => project.id !== deletingProjectId));
